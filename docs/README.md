...
> **This repository fork also ships [HuskySU](../README.md)** ([简体中文](../README_CN.md)) — a Pixel 8 Pro (`husky`) LKM maintenance build (`me.weishu.kernelsu.husky.fork`) with Material 3 Expressive UI, in-app LKM updates, environment check, and `husky-v*` Releases. Device guide: [husky.md](husky.md). The text below is the upstream KernelSU project README (credits retained).
